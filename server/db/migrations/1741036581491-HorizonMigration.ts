...
export class HorizonMigration1741036581491 implements MigrationInterface {
    name = 'HorizonMigration1741036581491'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rights" ("id" SERIAL NOT NULL, "name" character varying(30) NOT NULL, "internalName" character varying(30) NOT NULL, "description" text NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5e0a1183cb807bf9a0f311a8852" UNIQUE ("name"), CONSTRAINT "UQ_31ab7eb10b3125046057c9cc191" UNIQUE ("internalName"), CONSTRAINT "PK_afafc4832726585c98fff471fea" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "roles" ("id" SERIAL NOT NULL, "name" character varying(30) NOT NULL, "description" text NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_648e3f5447f725579d7d4ffdfb7" UNIQUE ("name"), CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "link_tags" ("id" SERIAL NOT NULL, "name" character varying(64) NOT NULL, CONSTRAINT "UQ_4e78219466e135ddbb118721334" UNIQUE ("name"), CONSTRAINT "PK_aaf1cfe913fc81bc4fc3427d106" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "links" ("id" SERIAL NOT NULL, "name" character varying(256) NOT NULL, "description" text NOT NULL, "url" character varying(256) NOT NULL, "status" character(1) NOT NULL DEFAULT 'A', "thumbnail" character varying(512), "click_count" integer NOT NULL DEFAULT '0', "last_updated" TIMESTAMP NOT NULL DEFAULT now(), "categoryId" integer, CONSTRAINT "UQ_3f1ec0636d54a293469ea03f12c" UNIQUE ("name"), CONSTRAINT "UQ_ff2e76673883ad4ea9f92fe32b8" UNIQUE ("url"), CONSTRAINT "PK_ecf17f4a741d3c5ba0b4c5ab4b6" PRIMARY KEY ("id"))`);
