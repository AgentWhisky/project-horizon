...
export class HorizonMigration1758722519669 implements MigrationInterface {
    name = 'HorizonMigration1758722519669'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "screenshots" SET DEFAULT '[]'::jsonb`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "movies" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "movies" SET DEFAULT '[]'::jsonb`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "achievements" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "achievements" SET DEFAULT '{ "total": 0,"data": [] }'::jsonb`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "package_groups" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "package_groups" SET DEFAULT '[]'::jsonb`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "demos" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "steam_apps" ALTER COLUMN "demos" SET DEFAULT '[]'::jsonb`);
    }
