...
export class HorizonMigration1737940301806 implements MigrationInterface {
    name = 'HorizonMigration1737940301806'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rights" ("id" SERIAL NOT NULL, "name" character varying(30) NOT NULL, "internalName" character varying(30) NOT NULL, "description" text NOT NULL, "active" boolean NOT NULL DEFAULT true, "createdBy" integer, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" integer, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5e0a1183cb807bf9a0f311a8852" UNIQUE ("name"), CONSTRAINT "UQ_31ab7eb10b3125046057c9cc191" UNIQUE ("internalName"), CONSTRAINT "PK_afafc4832726585c98fff471fea" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "roles" ("id" SERIAL NOT NULL, "name" character varying(30) NOT NULL, "description" text NOT NULL, "active" boolean NOT NULL DEFAULT true, "createdBy" integer, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" integer, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_648e3f5447f725579d7d4ffdfb7" UNIQUE ("name"), CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying(30) NOT NULL, "email" character varying(30) NOT NULL, "createdBy" integer, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" integer, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_51b8b26ac168fbe7d6f5653e6cf" UNIQUE ("name"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
